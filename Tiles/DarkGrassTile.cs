...
{
    public class DarkGrassTile : ModTile
    {
        ...
        public override void RandomUpdate(int i, int j)
        {
            if (rand.Next(0, 10) == 3)
            {
                if (Main.tile[i + 1, j].type == (ushort)mod.TileType("DarkGrassTile"))
                {
                ...
                if (Main.tile[i, j - 1].type == (ushort)mod.TileType("DarkGrassTile"))
                {
                    bool TileOnTop = true;
                }
                else
                ...
                if (Main.tile[i + 1, j + 1].type == (ushort)mod.TileType("DarkGrassTile"))
                {
                ...
                {
                    Main.tile[i + 1, j].type = (ushort)mod.TileType("DarkGrassTile");
                }
                if (Main.tile[i - 1, j].type == (ushort)mod.TileType("DarkSoilTile"))
                {
                    Main.tile[i - 1, j].type = (ushort)mod.TileType("DarkGrassTile");
                ...
                {
                    Main.tile[i, j + 1].type = (ushort)mod.TileType("DarkGrassTile");
                }
                if (Main.tile[i, j - 1].type == (ushort)mod.TileType("DarkSoilTile"))
                {
                    Main.tile[i, j - 1].type = (ushort)mod.TileType("DarkGrassTile");
                ...
                {
                    Main.tile[i + 1, j + 1].type = (ushort)mod.TileType("DarkGrassTile");
                }
                if (Main.tile[i + 1, j - 1].type == (ushort)mod.TileType("DarkSoilTile"))
                {
                    Main.tile[i + 1, j - 1].type = (ushort)mod.TileType("DarkGrassTile");
