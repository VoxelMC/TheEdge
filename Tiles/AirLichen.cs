...
{
	public class AirLichen : ModTile
	{
        public override void SetDefaults()
        {
            ...
            AddMapEntry(new Color(13, 88, 130), "Air Lichen");
        ...
        public override bool Drop(int i, int j)
        {
            ...
            if (stage == 2)
            {
                ...
                Item.NewItem(i * 16, j * 16, 0, 0, mod.ItemType("AirLichenSeeds"));
            }
            return false;
        }
