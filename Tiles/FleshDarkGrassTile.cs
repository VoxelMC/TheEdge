...
{
    public class FleshDarkGrassTile : ModTile
    {
        ...
        public override void RandomUpdate(int i, int j)
        {
            if (rand.Next(0, 10) == 3)
            {
                if (Main.tile[i + 1, j].type == (ushort)mod.TileType("FleshDarkGrassTile"))
                {
                ...
                if (Main.tile[i, j - 1].type == (ushort)mod.TileType("FleshDarkGrassTile"))
                {
                    bool TileOnTop = true;
                }
                else
                ...
                if (Main.tile[i + 1, j + 1].type == (ushort)mod.TileType("FleshDarkGrassTile"))
                {
                ...
                {
                    Main.tile[i + 1, j].type = (ushort)mod.TileType("FleshDarkGrassTile");
                }
                if (Main.tile[i - 1, j].type == (ushort)mod.TileType("DarkSoilTile"))
                {
                    Main.tile[i - 1, j].type = (ushort)mod.TileType("FleshDarkGrassTile");
                ...
                {
                    Main.tile[i, j + 1].type = (ushort)mod.TileType("FleshDarkGrassTile");
                }
                if (Main.tile[i, j - 1].type == (ushort)mod.TileType("DarkSoilTile"))
                {
                    Main.tile[i, j - 1].type = (ushort)mod.TileType("FleshDarkGrassTile");
                ...
                {
                    Main.tile[i + 1, j + 1].type = (ushort)mod.TileType("FleshDarkGrassTile");
                }
                if (Main.tile[i + 1, j - 1].type == (ushort)mod.TileType("DarkSoilTile"))
                {
                    Main.tile[i + 1, j - 1].type = (ushort)mod.TileType("FleshDarkGrassTile");
