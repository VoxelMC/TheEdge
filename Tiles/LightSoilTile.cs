...
{
    public class LightSoilTile : ModTile
    {
        public override void SetDefaults()
        {
            ...
            drop = mod.ItemType("LightSoil");   //put your CustomBlock name
            ...
            SetModTree(new BlondWoodTree());
        }

        public override int SaplingGrowthType(ref int style)
        {
            style = 0;
            return mod.TileType("BlondWoodSapling");
        }
