...
{
    public class BlackSeededDarkSoilTile : ModTile
    {
        public override void SetDefaults()
        {
            ...
            drop = mod.ItemType("BlackSeededDarkSoil");   //put your CustomBlock name
            ...
            SetModTree(new BlackOakTree());
        }
        public override int SaplingGrowthType(ref int style)
        {
            style = 0;
            return mod.TileType("BlackOakSapling");
        }
